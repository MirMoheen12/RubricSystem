        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaperId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Papers", x => x.PaperId);
                    table.ForeignKey(
                        name: "FK_Papers_Papers_PaperId1",
                        column: x => x.PaperId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RubricClass = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Numbers1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_Papers_PaperId",
                        column: x => x.PaperId,
                        principalTable: "Papers",
                        principalColumn: "PaperId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EvaluatieTaskId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluatieTasks", x => x.EvaluatieTaskId);
                    table.ForeignKey(
                        name: "FK_EvaluatieTasks_Rubrics_RubricId",
                        column: x => x.RubricId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluatieTasks_RubricId",
                table: "EvaluatieTasks",
                column: "RubricId");

            migrationBuilder.CreateIndex(
                name: "IX_Papers_PaperId1",
                table: "Papers",
                column: "PaperId1");
